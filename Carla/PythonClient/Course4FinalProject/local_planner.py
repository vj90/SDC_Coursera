...
class LocalPlanner:
    ...
    def get_goal_state_set(self, goal_index, goal_state, waypoints, ego_state):
        ...
        # ------------------------------------------------------------------
        goal_heading_index = min(goal_index+1,len(waypoints)-1)
        delta_x = waypoints[goal_heading_index][0] - waypoints[goal_heading_index-1][0]
        delta_y = waypoints[goal_heading_index][1] - waypoints[goal_heading_index-1][1]
